...
.overlay {
	background: #0a18dc;
	background: -webkit-linear-gradient(to right, #2b39ff, #0909de);
	background: linear-gradient(to right, #1b0fc5, #1815d3);
...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-in-container">
			...
			@if (session('message2'))
				<p style="color:red;font-size:10px;margin: 0px;margin-right: 40px;">{{ session('message2') }}</p>
			@endif
